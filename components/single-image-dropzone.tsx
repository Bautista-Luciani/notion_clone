...
/* Definimos el width y height como opcional */
type InputProps = {
    width?: number;
    height?: number;
    className?: string;
...
const SingleImageDropzone = React.forwardRef<HTMLInputElement, InputProps>(
    (
        ...
        return (
            /* Le agregamos el className "relative" al div */
            <div className='relative'>
                {/* Agregamos este condicional para mejorar la interfaz de carga */}
                {disabled && (
                ...
                >
                    ...
                    {imageUrl ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                            ...
                            {/* Cambiamos el texto "drag & drop to upload" por "Click or drag file to this area to upload" */}
                            <div className="text-gray-400">Click or drag file to this area to upload</div>
                            {/* Removemos el div con el button que se encontraba aca abajo */}
                            <div className="mt-3">
